 ...
 */
class TopicType implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "TopicType";
    ...
    public function setTopicType($topic_type)
    {
        if (mb_strlen($topic_type) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_type when calling TopicType., must be smaller than or equal to 255.'
            );
        }
