...
class Pin implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        "name" => "string",
        "color" => "string",
        "point" => "\OpenAPI\Client\Model\Point",
    ];
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling Pin., must be smaller than or equal to 256.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 8) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling Pin., must be smaller than or equal to 8.'
            );
        }
     ...
     * Sets point
     *
     * @param \OpenAPI\Client\Model\Point $point point
     *
     * @return self
     */
