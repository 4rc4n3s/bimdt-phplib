...
/**
 * PatchedUnitRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedUnitRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedUnitRequest";
    ...
    public function setType($type)
    {
        if (!is_null($type) && mb_strlen($type) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $type when calling PatchedUnitRequest., must be bigger than or equal to 1.'
            );
        }
