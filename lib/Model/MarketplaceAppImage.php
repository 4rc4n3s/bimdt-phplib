...
/**
 * MarketplaceAppImage Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MarketplaceAppImage implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "MarketplaceAppImage";
    ...
    public function setImage($image)
    {
        if (is_null($image)) {
            throw new \InvalidArgumentException(
                "non-nullable image cannot be null"
            );
        }
    ...
    public function setOrder($order)
    {
        if (is_null($order)) {
            throw new \InvalidArgumentException(
                "non-nullable order cannot be null"
            );
        }
