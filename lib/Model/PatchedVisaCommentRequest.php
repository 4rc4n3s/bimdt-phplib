...
/**
 * PatchedVisaCommentRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedVisaCommentRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedVisaCommentRequest";
     ...
     * Sets author_id
     *
     * @param int|null $author_id This is the userproject_id. This field is only used if the call is made from an App
     *
     * @return self
     */
    public function setAuthorId($author_id)
    {
        if (is_null($author_id)) {
            throw new \InvalidArgumentException(
                "non-nullable author_id cannot be null"
            );
        }
    ...
    public function setContent($content)
    {
        if (is_null($content)) {
            throw new \InvalidArgumentException(
                "non-nullable content cannot be null"
            );
        }
