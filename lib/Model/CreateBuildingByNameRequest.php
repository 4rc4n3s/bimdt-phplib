...
/**
 * CreateBuildingByNameRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateBuildingByNameRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "CreateBuildingByNameRequest";
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling CreateBuildingByNameRequest., must be smaller than or equal to 512.'
            );
        }
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling CreateBuildingByNameRequest., must be bigger than or equal to 1.'
            );
        }
