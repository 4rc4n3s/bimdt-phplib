...
/**
 * StoreyBuildingRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StoreyBuildingRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "Storey_BuildingRequest";
    ...
    public function setName($name)
    {
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling StoreyBuildingRequest., must be bigger than or equal to 1.'
            );
        }
