...
/**
 * CloudInvitation Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CloudInvitation implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "CloudInvitation";
    ...
    public function setEmail($email)
    {
        if (mb_strlen($email) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $email when calling CloudInvitation., must be smaller than or equal to 256.'
            );
        }
    ...
    public function setRedirectUri($redirect_uri)
    {
        if (mb_strlen($redirect_uri) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $redirect_uri when calling CloudInvitation., must be smaller than or equal to 512.'
            );
        }
