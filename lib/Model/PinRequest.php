...
class PinRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PinRequest";
    ...
    protected static $openAPITypes = [
        "name" => "string",
        "color" => "string",
        "point" => "\OpenAPI\Client\Model\PointRequest",
    ];
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PinRequest., must be smaller than or equal to 256.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 8) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling PinRequest., must be smaller than or equal to 8.'
            );
        }
     ...
     * Sets point
     *
     * @param \OpenAPI\Client\Model\PointRequest $point point
     *
     * @return self
     */
    public function setPoint($point)
    {
        if (is_null($point)) {
            throw new \InvalidArgumentException(
                "non-nullable point cannot be null"
            );
        }
