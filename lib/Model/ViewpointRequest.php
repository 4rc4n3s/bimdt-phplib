...
/**
 * ViewpointRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ViewpointRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "ViewpointRequest";
    ...
    public function setIndex($index)
    {
        if (!is_null($index) && $index > 2147483647) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling ViewpointRequest., must be smaller than or equal to 2147483647.'
            );
        }
        if (!is_null($index) && $index < 0) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling ViewpointRequest., must be bigger than or equal to 0.'
            );
        }
    ...
    public function setOriginatingSystem($originating_system)
    {
        if (
            ...
            throw new \InvalidArgumentException(
                'invalid length for $originating_system when calling ViewpointRequest., must be smaller than or equal to 256.'
            );
        }
    ...
    public function setAuthoringToolId($authoring_tool_id)
    {
        if (
            ...
            throw new \InvalidArgumentException(
                'invalid length for $authoring_tool_id when calling ViewpointRequest., must be smaller than or equal to 256.'
            );
        }
