...
/**
 * ComponentsParentRequestVisibility Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ComponentsParentRequestVisibility implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "ComponentsParentRequest_visibility";
    ...
    protected static $openAPITypes = [
        ...
        "exceptions" => "\OpenAPI\Client\Model\ComponentRequest[]",
        "view_setup_hints" => "\OpenAPI\Client\Model\ViewSetupHintsRequest",
    ];
    ...
    {
        $this->setIfExists("default_visibility", $data ?? [], null);
        $this->setIfExists("exceptions", $data ?? [], null);
        $this->setIfExists("view_setup_hints", $data ?? [], null);
    }
    ...
    public function setDefaultVisibility($default_visibility)
    {
        if (is_null($default_visibility)) {
            throw new \InvalidArgumentException(
                "non-nullable default_visibility cannot be null"
            );
        }
     ...
     * Sets exceptions
     *
     * @param \OpenAPI\Client\Model\ComponentRequest[]|null $exceptions exceptions
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ViewSetupHintsRequest
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ViewSetupHintsRequest $view_setup_hints view_setup_hints
     *
     * @return self
     */
    public function setViewSetupHints($view_setup_hints)
    {
        if (is_null($view_setup_hints)) {
            throw new \InvalidArgumentException(
                "non-nullable view_setup_hints cannot be null"
            );
        }
