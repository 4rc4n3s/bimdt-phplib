...
/**
 * ComponentRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ComponentRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "ComponentRequest";
    ...
    public function setIfcGuid($ifc_guid)
    {
        if (!is_null($ifc_guid) && mb_strlen($ifc_guid) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $ifc_guid when calling ComponentRequest., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setOriginatingSystem($originating_system)
    {
        if (
            ...
            throw new \InvalidArgumentException(
                'invalid length for $originating_system when calling ComponentRequest., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setAuthoringToolId($authoring_tool_id)
    {
        if (
            ...
            throw new \InvalidArgumentException(
                'invalid length for $authoring_tool_id when calling ComponentRequest., must be smaller than or equal to 255.'
            );
        }
