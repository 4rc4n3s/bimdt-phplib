...
/**
 * PatchedIfcCheckerRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedIfcCheckerRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedIfcCheckerRequest";
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists("checkplan_id", $data ?? [], null);
    }
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedIfcCheckerRequest., must be smaller than or equal to 256.'
            );
        }
    ...
    {
        if (is_null($checkplan_id)) {
            throw new \InvalidArgumentException(
                "non-nullable checkplan_id cannot be null"
            );
        }
