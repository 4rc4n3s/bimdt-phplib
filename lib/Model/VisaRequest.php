 ...
 */
class VisaRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "VisaRequest";
     ...
     * Sets creator_id
     *
     * @param int|null $creator_id This is the userproject_id. This field is only used if the call is made from an App
     *
     * @return self
     */
    public function setCreatorId($creator_id)
    {
        if (is_null($creator_id)) {
            throw new \InvalidArgumentException(
                "non-nullable creator_id cannot be null"
            );
        }
