...
/**
 * FullTopicRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FullTopicRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "FullTopicRequest";
    ...
    public function setCreationAuthor($creation_author)
    {
        if (!is_null($creation_author) && mb_strlen($creation_author) > 254) {
            throw new \InvalidArgumentException(
                'invalid length for $creation_author when calling FullTopicRequest., must be smaller than or equal to 254.'
            );
        }
    ...
    public function setModifiedAuthor($modified_author)
    {
        if (!is_null($modified_author) && mb_strlen($modified_author) > 254) {
            throw new \InvalidArgumentException(
                'invalid length for $modified_author when calling FullTopicRequest., must be smaller than or equal to 254.'
            );
        }
    ...
    public function setTitle($title)
    {
        if (mb_strlen($title) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $title when calling FullTopicRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setTopicType($topic_type)
    {
        if (!is_null($topic_type) && mb_strlen($topic_type) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_type when calling FullTopicRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setTopicStatus($topic_status)
    {
        if (!is_null($topic_status) && mb_strlen($topic_status) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_status when calling FullTopicRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setStage($stage)
    {
        if (!is_null($stage) && mb_strlen($stage) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $stage when calling FullTopicRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setPriority($priority)
    {
        if (!is_null($priority) && mb_strlen($priority) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $priority when calling FullTopicRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setIndex($index)
    {
        if (!is_null($index) && $index > 2147483647) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling FullTopicRequest., must be smaller than or equal to 2147483647.'
            );
        }
        if (!is_null($index) && $index < 0) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling FullTopicRequest., must be bigger than or equal to 0.'
            );
        }
    ...
    public function setAssignedTo($assigned_to)
    {
        if (!is_null($assigned_to) && mb_strlen($assigned_to) > 254) {
            throw new \InvalidArgumentException(
                'invalid length for $assigned_to when calling FullTopicRequest., must be smaller than or equal to 254.'
            );
        }
    ...
    public function setFormat($format)
    {
        if (!is_null($format) && mb_strlen($format) > 64) {
            throw new \InvalidArgumentException(
                'invalid length for $format when calling FullTopicRequest., must be smaller than or equal to 64.'
            );
        }
        if (!is_null($format) && mb_strlen($format) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $format when calling FullTopicRequest., must be bigger than or equal to 1.'
            );
        }
