 ...
 */
class VisaComment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "VisaComment";
     ...
     * Sets author
     *
     * @param UserProject $author author
     *
     * @return self
     */
    public function setAuthor($author)
    {
        if (is_null($author)) {
            throw new \InvalidArgumentException(
                "non-nullable author cannot be null"
            );
        }
