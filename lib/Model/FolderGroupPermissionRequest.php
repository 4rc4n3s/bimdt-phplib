...
/**
 * FolderGroupPermissionRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FolderGroupPermissionRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "FolderGroupPermissionRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if (
            !is_null($this->container["permission"]) &&
            $this->container["permission"] > 32767
        ) {
            $invalidProperties[] =
                "invalid value for 'permission', must be smaller than or equal to 32767.";
        }

        if (
            !is_null($this->container["permission"]) &&
            $this->container["permission"] < -32768
        ) {
            $invalidProperties[] =
                "invalid value for 'permission', must be bigger than or equal to -32768.";
        }
     ...
     * Gets group
     *
     * @return \OpenAPI\Client\Model\GroupRequest
     */
     ...
     * Sets group
     *
     * @param \OpenAPI\Client\Model\GroupRequest $group group
     *
     * @return self
     */
    public function setGroup($group)
    {
        if (is_null($group)) {
            throw new \InvalidArgumentException(
                "non-nullable group cannot be null"
            );
        }
    ...
    public function setPermission($permission)
    {
        ...
        if (
            !is_null($permission) &&
            !in_array($permission, $allowedValues, true)
        ) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'permission', must be one of '%s'",
        ...
        if (!is_null($permission) && $permission > 32767) {
            throw new \InvalidArgumentException(
                'invalid value for $permission when calling FolderGroupPermissionRequest., must be smaller than or equal to 32767.'
            );
        }
        if (!is_null($permission) && $permission < -32768) {
            throw new \InvalidArgumentException(
                'invalid value for $permission when calling FolderGroupPermissionRequest., must be bigger than or equal to -32768.'
            );
        }
