 ...
 */
class PatchedGroupRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedGroupRequest., must be smaller than or equal to 512.'
            );
        }
        if (!is_null($name) && mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedGroupRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling PatchedGroupRequest., must be smaller than or equal to 255.'
            );
        }
