...
/**
 * VisaValidationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class VisaValidationRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "VisaValidationRequest";
    ...
    {
        $this->setIfExists("validator_id", $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container["validator_id"] === null) {
            $invalidProperties[] = "'validator_id' can't be null";
        }
     ...
     * Sets validator_id
     *
     * @param int $validator_id This is the userproject_id
     *
     * @return self
     */
    public function setValidatorId($validator_id)
    {
        if (is_null($validator_id)) {
            throw new \InvalidArgumentException(
                "non-nullable validator_id cannot be null"
            );
        }
