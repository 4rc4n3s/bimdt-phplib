...
class TagRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets name
     *
     * @param string $name Full name of the tags
     *
     * @return self
     */
    public function setName($name)
    {
        if (mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling TagRequest., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling TagRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 6) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling TagRequest., must be smaller than or equal to 6.'
            );
        }
