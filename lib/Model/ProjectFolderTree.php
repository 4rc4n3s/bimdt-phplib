...
/**
 * ProjectFolderTree Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectFolderTree implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "ProjectFolderTree";
    ...
    protected static $openAPITypes = [
        "name" => "string",
        "folders" => "\OpenAPI\Client\Model\FolderTree[]",
    ];
     ...
     * Gets folders
     *
     * @return \OpenAPI\Client\Model\FolderTree[]
     */
     ...
     * Sets folders
     *
     * @param \OpenAPI\Client\Model\FolderTree[] $folders folders
     *
     * @return self
     */
    public function setFolders($folders)
    {
        if (is_null($folders)) {
            throw new \InvalidArgumentException(
                "non-nullable folders cannot be null"
            );
        }
