...
/**
 * TopicTypeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TopicTypeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "TopicTypeRequest";
    ...
    {
        if (mb_strlen($topic_type) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_type when calling TopicTypeRequest., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($topic_type) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_type when calling TopicTypeRequest., must be bigger than or equal to 1.'
            );
        }
