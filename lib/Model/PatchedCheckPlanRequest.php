...
/**
 * PatchedCheckPlanRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PatchedCheckPlanRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedCheckPlanRequest";
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedCheckPlanRequest., must be bigger than or equal to 1.'
            );
        }
