 ...
 */
class CloudRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "CloudRole";
    ...
    public function setRole($role)
    {
        ...
        if (!is_null($role) && $role > 32767) {
            throw new \InvalidArgumentException(
                'invalid value for $role when calling CloudRole., must be smaller than or equal to 32767.'
            );
        }
        if (!is_null($role) && $role < -32768) {
            throw new \InvalidArgumentException(
                'invalid value for $role when calling CloudRole., must be bigger than or equal to -32768.'
            );
        }
