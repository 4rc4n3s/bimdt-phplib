...
class FolderTree implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "FolderTree";
    ...
    protected static $openAPITypes = [
        "children" => "\OpenAPI\Client\Model\FolderTree[]",
        "name" => "string",
    ];
     ...
     * Sets children
     *
     * @param \OpenAPI\Client\Model\FolderTree[] $children children
     *
     * @return self
     */
