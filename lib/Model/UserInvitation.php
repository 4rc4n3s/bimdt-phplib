...
class UserInvitation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        "status" => "string",
        "client_name" => "string",
        "sender" => "\OpenAPI\Client\Model\User",
        "created_at" => "\DateTime",
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists("cloud_id", $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container["cloud_id"] === null) {
            $invalidProperties[] = "'cloud_id' can't be null";
        }
    ...
    public function setRedirectUri($redirect_uri)
    {
        if (mb_strlen($redirect_uri) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $redirect_uri when calling UserInvitation., must be smaller than or equal to 512.'
            );
        }
    ...
    public function setCloudId($cloud_id)
    {
        if (is_null($cloud_id)) {
            throw new \InvalidArgumentException(
                "non-nullable cloud_id cannot be null"
            );
        }
    ...
    public function setClientName($client_name)
    {
        if (is_null($client_name)) {
            throw new \InvalidArgumentException(
                "non-nullable client_name cannot be null"
            );
        }
     ...
     * Sets sender
     *
     * @param \OpenAPI\Client\Model\User $sender sender
     *
     * @return self
     */
    public function setSender($sender)
    {
        if (is_null($sender)) {
            throw new \InvalidArgumentException(
                "non-nullable sender cannot be null"
            );
        }
