...
class Viewpoint implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        "orthogonal_camera" =>
            "\OpenAPI\Client\Model\ViewpointOrthogonalCamera",
        "perspective_camera" =>
            "\OpenAPI\Client\Model\ViewpointPerspectiveCamera",
        "lines" => "\OpenAPI\Client\Model\Line[]",
        "clipping_planes" => "\OpenAPI\Client\Model\ClippingPlane[]",
        "snapshot" => "\OpenAPI\Client\Model\ViewpointSnapshot",
        "components" => "\OpenAPI\Client\Model\ViewpointComponents",
    ...
    public function setIndex($index)
    {
        if (!is_null($index) && $index > 2147483647) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling Viewpoint., must be smaller than or equal to 2147483647.'
            );
        }
        if (!is_null($index) && $index < 0) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling Viewpoint., must be bigger than or equal to 0.'
            );
        }
    ...
    public function setOriginatingSystem($originating_system)
    {
        if (
            ...
            throw new \InvalidArgumentException(
                'invalid length for $originating_system when calling Viewpoint., must be smaller than or equal to 256.'
            );
        }
    ...
    public function setAuthoringToolId($authoring_tool_id)
    {
        if (
            ...
            throw new \InvalidArgumentException(
                'invalid length for $authoring_tool_id when calling Viewpoint., must be smaller than or equal to 256.'
            );
        }
     ...
     *
     * @return \OpenAPI\Client\Model\ViewpointOrthogonalCamera|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ViewpointOrthogonalCamera|null $orthogonal_camera orthogonal_camera
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ViewpointPerspectiveCamera|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ViewpointPerspectiveCamera|null $perspective_camera perspective_camera
     *
     * @return self
     */
     ...
     * Gets snapshot
     *
     * @return \OpenAPI\Client\Model\ViewpointSnapshot|null
     */
     ...
     * Sets snapshot
     *
     * @param \OpenAPI\Client\Model\ViewpointSnapshot|null $snapshot snapshot
     *
     * @return self
     */
     ...
     * Gets components
     *
     * @return \OpenAPI\Client\Model\ViewpointComponents|null
     */
     ...
     * Sets components
     *
     * @param \OpenAPI\Client\Model\ViewpointComponents|null $components components
     *
     * @return self
     */
     ...
     * Sets pins
     *
     * @param \OpenAPI\Client\Model\Pin[]|null $pins Non standard field. Pins (or markers/annotations) are points of interest
     *
     * @return self
     */
