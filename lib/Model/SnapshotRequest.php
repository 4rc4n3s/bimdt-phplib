...
/**
 * SnapshotRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class SnapshotRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "SnapshotRequest";
    ...
    public function setSnapshotType($snapshot_type)
    {
        if (mb_strlen($snapshot_type) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $snapshot_type when calling SnapshotRequest., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($snapshot_type) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $snapshot_type when calling SnapshotRequest., must be bigger than or equal to 1.'
            );
        }
