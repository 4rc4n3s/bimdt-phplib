...
/**
 * PatchedStoreyBuildingRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedStoreyBuildingRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedStorey_BuildingRequest";
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedStoreyBuildingRequest., must be bigger than or equal to 1.'
            );
        }
