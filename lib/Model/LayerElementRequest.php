...
/**
 * LayerElementRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LayerElementRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "LayerElementRequest";
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling LayerElementRequest., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling LayerElementRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setIdentifier($identifier)
    {
        if (!is_null($identifier) && mb_strlen($identifier) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $identifier when calling LayerElementRequest., must be smaller than or equal to 255.'
            );
        }
