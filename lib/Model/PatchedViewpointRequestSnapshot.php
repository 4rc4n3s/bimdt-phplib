...
/**
 * PatchedViewpointRequestSnapshot Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedViewpointRequestSnapshot implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedViewpointRequest_snapshot";
    ...
    public function listInvalidProperties()
    {
        ...
        if (mb_strlen($this->container["snapshot_type"]) < 1) {
            $invalidProperties[] =
                "invalid value for 'snapshot_type', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setSnapshotType($snapshot_type)
    {
        if (mb_strlen($snapshot_type) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $snapshot_type when calling PatchedViewpointRequestSnapshot., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($snapshot_type) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $snapshot_type when calling PatchedViewpointRequestSnapshot., must be bigger than or equal to 1.'
            );
        }
     ...
     * Sets snapshot_data
     *
     * @param \SplFileObject $snapshot_data snapshot_data
     *
     * @return self
     */
