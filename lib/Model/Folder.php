...
class Folder implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling Folder., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setDefaultPermission($default_permission)
    {
        ...
        if (!is_null($default_permission) && $default_permission > 32767) {
            throw new \InvalidArgumentException(
                'invalid value for $default_permission when calling Folder., must be smaller than or equal to 32767.'
            );
        }
        if (!is_null($default_permission) && $default_permission < -32768) {
            throw new \InvalidArgumentException(
                'invalid value for $default_permission when calling Folder., must be bigger than or equal to -32768.'
            );
        }
     ...
     * Gets children
     *
     * @return \OpenAPI\Client\Model\RecursiveFolderChildren[]
     */
     ...
     * Sets children
     *
     * @param \OpenAPI\Client\Model\RecursiveFolderChildren[] $children children
     *
     * @return self
     */
