 ...
 */
class PatchedTagRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (
            ...
            mb_strlen($this->container["color"]) > 6
        ) {
            $invalidProperties[] =
                "invalid value for 'color', the character length must be smaller than or equal to 6.";
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedTagRequest., must be smaller than or equal to 255.'
            );
        }
        if (!is_null($name) && mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling PatchedTagRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 6) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling PatchedTagRequest., must be smaller than or equal to 6.'
            );
        }
