 ...
 */
class TopicStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "TopicStatus";
    ...
    public function setTopicStatus($topic_status)
    {
        if (mb_strlen($topic_status) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_status when calling TopicStatus., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 8) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling TopicStatus., must be smaller than or equal to 8.'
            );
        }
