...
/**
 * RawUnitRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RawUnitRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "RawUnitRequest";
    ...
    protected static array $openAPINullables = [
        ...
        "dimensions" => true,
        "conversion_baseunit_index" => true,
        "is_default" => true,
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists("conversion_baseunit_index", $data ?? [], null);
    ...
    public function setType($type)
    {
        if (mb_strlen($type) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $type when calling RawUnitRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    {
        if (is_null($conversion_baseunit_index)) {
            array_push(
