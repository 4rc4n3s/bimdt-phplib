...
/**
 * StageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class StageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "StageRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if (mb_strlen($this->container["stage"]) > 255) {
            $invalidProperties[] =
                "invalid value for 'stage', the character length must be smaller than or equal to 255.";
        }
    ...
    {
        if (mb_strlen($stage) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $stage when calling StageRequest., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($stage) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $stage when calling StageRequest., must be bigger than or equal to 1.'
            );
        }
