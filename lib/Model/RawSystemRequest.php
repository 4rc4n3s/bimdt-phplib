...
/**
 * RawSystemRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RawSystemRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "RawSystemRequest";
    ...
    public function setUuid($uuid)
    {
        if (mb_strlen($uuid) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $uuid when calling RawSystemRequest., must be bigger than or equal to 1.'
            );
        }
