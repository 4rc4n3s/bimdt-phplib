...
/**
 * PatchedTopicStatusRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedTopicStatusRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedTopicStatusRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if (
            ...
            mb_strlen($this->container["topic_status"]) > 255
        ) {
            $invalidProperties[] =
    ...
    {
        if (!is_null($topic_status) && mb_strlen($topic_status) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_status when calling PatchedTopicStatusRequest., must be smaller than or equal to 255.'
            );
        }
        if (!is_null($topic_status) && mb_strlen($topic_status) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $topic_status when calling PatchedTopicStatusRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 8) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling PatchedTopicStatusRequest., must be smaller than or equal to 8.'
            );
        }
