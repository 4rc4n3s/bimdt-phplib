...
/**
 * CheckPlanRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CheckPlanRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "CheckPlanRequest";
    ...
    public function setName($name)
    {
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling CheckPlanRequest., must be bigger than or equal to 1.'
            );
        }
