 ...
 */
class Layer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "Layer";
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling Layer., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setIdentifier($identifier)
    {
        if (!is_null($identifier) && mb_strlen($identifier) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $identifier when calling Layer., must be smaller than or equal to 255.'
            );
        }
