...
/**
 * TagIdRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TagIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "TagIdRequest";
    ...
    public function setTagId($tag_id)
    {
        if (is_null($tag_id)) {
            throw new \InvalidArgumentException(
                "non-nullable tag_id cannot be null"
            );
        }
