...
class Topic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCreationAuthor($creation_author)
    {
        if (!is_null($creation_author) && mb_strlen($creation_author) > 254) {
            throw new \InvalidArgumentException(
                'invalid length for $creation_author when calling Topic., must be smaller than or equal to 254.'
            );
        }
    ...
    public function setModifiedAuthor($modified_author)
    {
        if (!is_null($modified_author) && mb_strlen($modified_author) > 254) {
            throw new \InvalidArgumentException(
                'invalid length for $modified_author when calling Topic., must be smaller than or equal to 254.'
            );
        }
    ...
    public function setAssignedTo($assigned_to)
    {
        if (!is_null($assigned_to) && mb_strlen($assigned_to) > 254) {
            throw new \InvalidArgumentException(
                'invalid length for $assigned_to when calling Topic., must be smaller than or equal to 254.'
            );
        }
    ...
    public function setFormat($format)
    {
        if (!is_null($format) && mb_strlen($format) > 64) {
            throw new \InvalidArgumentException(
                'invalid length for $format when calling Topic., must be smaller than or equal to 64.'
            );
        }
    ...
    public function setIndex($index)
    {
        if (!is_null($index) && $index > 2147483647) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling Topic., must be smaller than or equal to 2147483647.'
            );
        }
        if (!is_null($index) && $index < 0) {
            throw new \InvalidArgumentException(
                'invalid value for $index when calling Topic., must be bigger than or equal to 0.'
            );
        }
