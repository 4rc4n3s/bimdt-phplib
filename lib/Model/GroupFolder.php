...
class GroupFolder implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets folder
     *
     * @param FolderWithoutChildren $folder folder
     *
     * @return self
     */
    public function setFolder($folder)
    {
        if (is_null($folder)) {
            throw new \InvalidArgumentException(
                "non-nullable folder cannot be null"
            );
        }
    ...
    public function setPermission($permission)
    {
        ...
        if (!is_null($permission) && $permission > 32767) {
            throw new \InvalidArgumentException(
                'invalid value for $permission when calling GroupFolder., must be smaller than or equal to 32767.'
            );
        }
        if (!is_null($permission) && $permission < -32768) {
            throw new \InvalidArgumentException(
                'invalid value for $permission when calling GroupFolder., must be bigger than or equal to -32768.'
            );
        }
