    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling ProjectRequest., must be smaller than or equal to 256.'
            );
        }
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling ProjectRequest., must be bigger than or equal to 1.'
            );
        }
