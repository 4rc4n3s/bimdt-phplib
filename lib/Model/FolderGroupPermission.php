...
/**
 * FolderGroupPermission Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FolderGroupPermission implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "FolderGroupPermission";
     ...
     * Sets group
     *
     * @param \OpenAPI\Client\Model\Group $group group
     *
     * @return self
     */
    ...
    public function setPermission($permission)
    {
        ...
        if (!is_null($permission) && $permission > 32767) {
            throw new \InvalidArgumentException(
                'invalid value for $permission when calling FolderGroupPermission., must be smaller than or equal to 32767.'
            );
        }
        if (!is_null($permission) && $permission < -32768) {
            throw new \InvalidArgumentException(
                'invalid value for $permission when calling FolderGroupPermission., must be bigger than or equal to -32768.'
            );
        }
