...
/**
 * ProjectInvitationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ProjectInvitationRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "ProjectInvitationRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if (mb_strlen($this->container["email"]) < 1) {
            $invalidProperties[] =
                "invalid value for 'email', the character length must be bigger than or equal to 1.";
        }
        ...
        if (mb_strlen($this->container["redirect_uri"]) < 1) {
            $invalidProperties[] =
                "invalid value for 'redirect_uri', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setEmail($email)
    {
        if (mb_strlen($email) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $email when calling ProjectInvitationRequest., must be smaller than or equal to 256.'
            );
        }
        if (mb_strlen($email) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $email when calling ProjectInvitationRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setRedirectUri($redirect_uri)
    {
        if (mb_strlen($redirect_uri) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $redirect_uri when calling ProjectInvitationRequest., must be smaller than or equal to 512.'
            );
        }
        if (mb_strlen($redirect_uri) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $redirect_uri when calling ProjectInvitationRequest., must be bigger than or equal to 1.'
            );
        }
