...
/**
 * MaterialRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class MaterialRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "MaterialRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container["property_sets"] === null) {
            $invalidProperties[] = "'property_sets' can't be null";
        }
     ...
     * Gets property_sets
     *
     * @return \OpenAPI\Client\Model\PropertySetRequest[]
     */
     ...
     * Sets property_sets
     *
     * @param \OpenAPI\Client\Model\PropertySetRequest[] $property_sets property_sets
     *
     * @return self
     */
