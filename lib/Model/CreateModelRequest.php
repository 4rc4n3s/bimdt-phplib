...
/**
 * CreateModelRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateModelRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "CreateModelRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container["document_id"] < 1) {
            $invalidProperties[] =
                "invalid value for 'document_id', must be bigger than or equal to 1.";
        }
    ...
    public function setDocumentId($document_id)
    {
        if ($document_id < 1) {
            throw new \InvalidArgumentException(
                'invalid value for $document_id when calling CreateModelRequest., must be bigger than or equal to 1.'
            );
        }
