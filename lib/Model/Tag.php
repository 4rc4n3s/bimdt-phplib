...
class Tag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling Tag., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 6) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling Tag., must be smaller than or equal to 6.'
            );
        }
