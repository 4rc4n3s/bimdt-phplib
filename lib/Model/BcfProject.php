 ...
 */
class BcfProject implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "BcfProject";
    ...
    public function setProjectId($project_id)
    {
        if (is_null($project_id)) {
            throw new \InvalidArgumentException(
                "non-nullable project_id cannot be null"
            );
        }
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling BcfProject., must be smaller than or equal to 256.'
            );
        }
