...
/**
 * RawClassificationRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RawClassificationRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "RawClassificationRequest";
     ...
     * Sets notation
     *
     * @param string|null $notation notation
     *
     * @return self
     */
    ...
    {
        if (is_null($notation)) {
            array_push($this->openAPINullablesSetToNull, "notation");
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search("notation", $nullablesSetToNull);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
