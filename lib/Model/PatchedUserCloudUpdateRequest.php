...
/**
 * PatchedUserCloudUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedUserCloudUpdateRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedUserCloudUpdateRequest";
     ...
     * Sets cloud_role
     *
     * @param int|null $cloud_role cloud_role
     *
     * @return self
     */
    public function setCloudRole($cloud_role)
    {
        ...
        if (
            !is_null($cloud_role) &&
            !in_array($cloud_role, $allowedValues, true)
        ) {
