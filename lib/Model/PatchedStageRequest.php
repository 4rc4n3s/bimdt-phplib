...
/**
 * PatchedStageRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedStageRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedStageRequest";
    ...
    public function listInvalidProperties()
    {
        ...
        if (
            ...
            mb_strlen($this->container["stage"]) > 255
        ) {
            $invalidProperties[] =
    ...
    {
        if (!is_null($stage) && mb_strlen($stage) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $stage when calling PatchedStageRequest., must be smaller than or equal to 255.'
            );
        }
        if (!is_null($stage) && mb_strlen($stage) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $stage when calling PatchedStageRequest., must be bigger than or equal to 1.'
            );
        }
