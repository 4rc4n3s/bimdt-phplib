...
class ModelRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling ModelRequest., must be smaller than or equal to 512.'
            );
        }
    ...
    public function setWorldPosition($world_position)
    {
        if (!is_null($world_position) && count($world_position) > 3) {
            throw new \InvalidArgumentException(
                'invalid value for $world_position when calling ModelRequest., number of items must be less than or equal to 3.'
            );
        }
    ...
    public function setVersion($version)
    {
        if (!is_null($version) && mb_strlen($version) > 256) {
            throw new \InvalidArgumentException(
                'invalid length for $version when calling ModelRequest., must be smaller than or equal to 256.'
            );
        }
    ...
    public function setNorthVector($north_vector)
    {
        if (!is_null($north_vector) && count($north_vector) > 2) {
            throw new \InvalidArgumentException(
                'invalid value for $north_vector when calling ModelRequest., number of items must be less than or equal to 2.'
            );
        }
