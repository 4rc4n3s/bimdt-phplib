...
class Zone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setName($name)
    {
        if (!is_null($name) && mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling Zone., must be smaller than or equal to 255.'
            );
        }
    ...
    public function setUuid($uuid)
    {
        if (mb_strlen($uuid) > 512) {
            throw new \InvalidArgumentException(
                'invalid length for $uuid when calling Zone., must be smaller than or equal to 512.'
            );
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && mb_strlen($color) > 8) {
            throw new \InvalidArgumentException(
                'invalid length for $color when calling Zone., must be smaller than or equal to 8.'
            );
        }
