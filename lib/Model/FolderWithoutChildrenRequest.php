...
/**
 * FolderWithoutChildrenRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FolderWithoutChildrenRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "FolderWithoutChildrenRequest";
    ...
    public function setName($name)
    {
        if (mb_strlen($name) > 255) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling FolderWithoutChildrenRequest., must be smaller than or equal to 255.'
            );
        }
        if (mb_strlen($name) < 1) {
            throw new \InvalidArgumentException(
                'invalid length for $name when calling FolderWithoutChildrenRequest., must be bigger than or equal to 1.'
            );
        }
    ...
    public function setDefaultPermission($default_permission)
    {
        ...
        if (!is_null($default_permission) && $default_permission > 32767) {
            throw new \InvalidArgumentException(
                'invalid value for $default_permission when calling FolderWithoutChildrenRequest., must be smaller than or equal to 32767.'
            );
        }
        if (!is_null($default_permission) && $default_permission < -32768) {
            throw new \InvalidArgumentException(
                'invalid value for $default_permission when calling FolderWithoutChildrenRequest., must be bigger than or equal to -32768.'
            );
        }
