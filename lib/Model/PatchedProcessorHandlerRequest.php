...
/**
 * PatchedProcessorHandlerRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PatchedProcessorHandlerRequest implements
    ModelInterface,
    ArrayAccess,
    \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = "PatchedProcessorHandlerRequest";
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists("detail_message", $data ?? [], null);
    }
    ...
    {
        if (is_null($detail_message)) {
            array_push($this->openAPINullablesSetToNull, "detail_message");
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search("detail_message", $nullablesSetToNull);
            if ($index !== false) {
